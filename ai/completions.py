...
Не типируй заранее; если тип неизвестен, указывай только яркие ЧЕРТЫ ХАРАКТЕРА и функции/элементы, которые могут помочь при типировании.
